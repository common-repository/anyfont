...
Tags: images, styles, fonts, admin, theme, enhancement, truetype, opentype, typography, ttf, font, woff, plugin, css3, @font-face, webfont, titles, posts, pages, wpmu
...
* Bugfix: Fixed minor bug reported by [Daniel](http://twitter.com/cr4y)
...
* Enhancement: Added translation: French (fr_FR) - Thanks [Eve](http://www.webhostinghub.com/).
* Enhancement: Added translation: Azerbaijani (az_AZ) - Thanks [Bohdan](http://webhostingrating.com/).
...
= 2.2.3 =
Bugfix release. Update if you having problems generating images.

= 2.2.2 =
Minor update which fixes a couple of minor bugs, adds some translations and adds a new feature which allows you to use CSS3 Webfonts directly in the WP editor.

= 2.2.1 =
Minor update which adds some translations and one new feature allowing you to use CSS3 Webfonts directly in the WP editor.
